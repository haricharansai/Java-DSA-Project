...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("6. Algorithms Lab (DSA Demo)");
            ...
            switch (ch) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    AlgorithmsLab.run(sc, complaints);
                    break;
                case 7:
    ...
    private static void addDemoUsers(Register reg) {
        reg.addUserDirect(new Register.User("Hari", "hari@gmail.com", "1234", "citizen"));
